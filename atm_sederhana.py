...
def transfer_uang(uang,no_rekening):
    ...
    if index1 >= 0:
        if user[index1]['saldo'] >= int (uang):
            ...
            print('Anda berhasil mentrasfer uang Rp.'+str(uang)+'ke Rekening'+no_rekening)
...
while pakai_atm == 'y':
    while status_login == False:
        print('SELAMAT DATANG DI ATM BANG JAGO')
    ...
    while loop == 'y' and status_login == True:
        ...
        print('SELAMAT DATANG DI ATM BANK JAGO')
        print('1.Cek Saldo')
        ...
        if a == 1:
            ...
            print('Untuk Mentrasfer Uang Silahkan Masukan No Rekening Tujuan')
            ...
            if cnk >= 0:
                ...
                print('')
                print('No Rekening Tujuan Tidak ditemukan atau tidak terdaftar')
                print('')
                loop = 'n'
